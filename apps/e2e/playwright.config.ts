    ...
    ? [
        {
          ...
          // Use the `env` object instead of inlining env assignments in the
          // command string — it's more robust and cross-shell safe.
          command: 'node dist/apps/api',
          port: 3000,
